...
int main (int argc, char *argv[]) {
    ...
    //g_signal_connect ( GTK_OBJECT(passwd_entry), "activate", GTK_SIGNAL_FUNC(input_completed), message_label);
    g_signal_connect(GTK_OBJECT(passwd_entry), "activate", G_CALLBACK(input_completed), user_entry);
